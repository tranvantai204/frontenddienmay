...
document.addEventListener('DOMContentLoaded', function () {
    ...
    fetch(`http://localhost/CuaHangDT/api/sanpham/read.php?category_id=1`)
    ...
    function filterProducts() {
        ...
        const filteredProducts = productsData.filter(product => {
            ...
            if (priceFilter === '0-10000000') {
                return productPrice < 10000000;
            } else if (priceFilter === '10000000-20000000') {
                return productPrice >= 10000000 && productPrice < 20000000;
            } else if (priceFilter === '20000000-30000000') {
                return productPrice >= 20000000 && productPrice < 30000000;
            } else if (priceFilter === '30000000-40000000') {
                return productPrice >= 30000000 && productPrice < 40000000;
            ...
            .then(data => {
                ...
                productDetail.innerHTML = `
                    ...
                    <div class="thumbnail_grid">
                        <img class="thumbnail" src="${product.thumbnail_image}" style="width:20%" onclick="currentSlide(1)">
